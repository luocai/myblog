...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="${APP_PATH }/static/images/82839-106.jpg" alt="第一张">
        </div>
        <div class="item">
            <img src="${APP_PATH }/static/images/05905-106.png" alt="第二张">
        </div>
        <div class="item">
            <img src="${APP_PATH }/static/images/296494-106.jpg" alt="第三张">
        </div>
