			...
			<c:forEach items="${years }" var="year">
				<c:choose>
					<c:when test="${currentYear == year }">
						<a class="nav__item nav__item--selected" href="javascript:void(0)" alt="${year }">${year }年 </a>
					</c:when>
					<c:otherwise>
						<a class="nav__item" href="archives?year=${year}" alt="${year }">${year }年 </a>
					</c:otherwise>
				</c:choose>
				
			</c:forEach>
		<!-- <a class="nav__item nav__item--selected" href="javascript:void(0)" alt="2018年">2018年 </a><a class="nav__item" href="http://blog.minfive.com/archives/2017/" alt="2017年">2017年 </a><a class="nav__item" href="http://blog.minfive.com/archives/2016/" alt="2016年">2016年</a> -->
		</nav>
		<div class="page__posts clearfix">
			<c:forEach items="${archiveArticle}" var="article">
