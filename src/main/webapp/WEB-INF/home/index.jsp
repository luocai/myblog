...
%>
    <meta charset="UTF-8">
    <title>星·光</title>
    <link rel="shortcut icon" type="image/x-icon" href="${APP_PATH }/static/images/web-icon.png" media="screen" />
        ...
        <nav>
            ...
            <div class="my-info" onmouseover="hiddeewm()" onmouseout="hiddeewm()">
                ...
                <div id="hiddenewm" hidden="true" >
                    <img src="${APP_PATH }/static/image/me.jpg" width="200px" height="200px" >
                    <p></p>
                </div>
            </div>
        </nav>
...
<c:forEach items="${articles}" var="article">
    <article class="article">
        ...
        <footer>
            <a href="article?id=${article.articleId}">阅读全文</a>
        </footer>
    </article>
</c:forEach>
        <div style="text-align: center">
            <ul class="pagination" >
               <li> <a href = "index?page=1">首页</a> </li>
			    	<li <c:if test="${pageInfo.pageNum==1}">class="disabled"</c:if>><a href="index?page=${pageInfo.pageNum-1 }">&laquo;</a></li>
