...
<%
	pageContext.setAttribute("APP_PATH", request.getContextPath()); /*根路径  */
	 ...
	 if (session.getAttribute("user") == null) {
        out.println("<script>window.location.href='" + session.getServletContext().getContextPath() + "/login';</script>");
    } 
%>
  <meta charset="utf-8">
  ...
  <script src="${APP_PATH }/static/js/jquery-3.2.1.min.js"></script>
   ...
   <!-- 引入wangEditor富文本编辑器 ！！！-->
    <script type="text/javascript" src="${APP_PATH }/static/release/wangEditor.min.js"></script>
